...
Python wrapper around the Google Generative AI SDK for all three BiasGuard prompts:
...
{{
  ...
  "counterfactual_hint": "One specific what-if scenario that illustrates bias (e.g., 'If district changed from Rural to Urban, approval probability increases by X%')",
...
def _fallback_bias_analysis(equity_score: int, dp: float) -> Dict[str, Any]:
    ...
    return {
        ...
        "explanation_hi": (
            ...
            f"यह असमानता निम्न समूहों के साथ व्यवस्थित भेदभाव का कारण बन सकती है।"
        ),
